...
/*  Author: Sodaboy                                             */
/*  Date: 07/22/2008                                            */
/*  accountadd.c :  Adds an account to the Tethealla PSO server */
/*                                                              */
/*  History:                                                    */
/*    10/15/2021  Modified to allow DAT usage                   */
...
/*
 * Updates a passed datafile
 * @param filename path to the datafile.
 * @param count number of lines in the datafile.
 * @param data actual data to go into the datafile.
 * @param record_size size of the new record.
 * @param new_record Not used.
 */
...
/*
 * Loads a passed datafile for reading/writing
 * @param filename path to the datafile.
 * @param count number of lines in the datafile.
 * @param data actual data to go into the datafile.
 * @param record_size size of the new record.
...
#else
  num_accounts = 0;
  // Manually pass the file 'account.dat' to the LoadDataFile function:
